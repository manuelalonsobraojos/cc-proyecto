...
setup(
    ...
    install_requires=['beautifulsoup4==4.8.1','certifi==2019.9.11','cffi==1.13.2','chardet==3.0.4','Click==7.0',
                      'Flask==1.1.1','sanic==20.12.7', 'Flask-Caching==1.8.0', 'gevent==1.4.0','greenlet==0.4.15','idna==2.8','itsdangerous==1.1.0','Jinja2==2.10.3', 'linecache2==1.0.0', 'MarkupSafe==1.1.1',
